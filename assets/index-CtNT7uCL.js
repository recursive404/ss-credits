...
void main() {
    ...
    `,document.body.appendChild(this.container),this.scoreEl=this.container.querySelector("#hud-score"),this.streakEl=this.container.querySelector("#hud-streak"),this.crosshair=this.container.querySelector("#hud-crosshair"),this.messageEl=this.container.querySelector("#hud-message"),this.hitFeedback=this.container.querySelector("#hud-hit")}updateScore(e,t){this.scoreEl.textContent=e.toString(),t>=3?(this.streakEl.textContent=`${t}x STREAK!`,this.streakEl.classList.add("active")):this.streakEl.classList.remove("active")}updateCrosshair(e,t){this.crosshair.style.left=`${e}px`,this.crosshair.style.top=`${t}px`}showMessage(e,t){this.messageEl.textContent=e,this.messageEl.classList.add("visible"),t>0&&setTimeout(()=>this.hideMessage(),t)}hideMessage(){this.messageEl.classList.remove("visible")}showHit(e,t,n,r){this.hitFeedback.textContent=`+${t} ${e}`,this.hitFeedback.style.left=`${n}px`,this.hitFeedback.style.top=`${r}px`,this.hitFeedback.classList.remove("show"),this.hitFeedback.offsetWidth,this.hitFeedback.classList.add("show"),setTimeout(()=>{this.hitFeedback.classList.remove("show")},500)}showShot(e,t,n){const r=document.createElement("div");r.className=`shot-ring ${e}`,r.style.left=`${t}px`,r.style.top=`${n}px`,this.container.appendChild(r),setTimeout(()=>{r.remove()},300)}showMiss(e,t,n){const r=document.createElement("div");r.className="hud-miss",r.textContent=e,r.style.left=`${t}px`,r.style.top=`${n}px`,this.container.appendChild(r),setTimeout(()=>{r.remove()},500)}}const jp="https://scoresaber.com/api";async function Jp(i=100){const e=[],n=Math.ceil(i/50);try{for(let r=1;r<=n;r++){const s=await fetch(`${jp}/players?page=${r}`);if(!s.ok)throw new Error(`API error: ${s.status}`);const a=await s.json();for(const o of a.players)if(e.push({name:o.name,rank:o.rank,country:o.country,pp:o.pp.toFixed(2),countryRank:o.countryRank,profilePicture:o.profilePicture,color:Math.random()>.5?"red":"blue"}),e.length>=i)break;if(e.length>=i)break;await new Promise(o=>setTimeout(o,100))}console.log(`✅ Fetched ${e.length} players from API`)}catch(r){return console.error("Failed to fetch players (CORS?):",r),console.log("📦 Using bundled player data..."),em()}return e}function Qp(i){return`https://api.dicebear.com/7.x/pixel-art/png?seed=${encodeURIComponent(i)}&size=128`}function em(){return[{name:"Bizzy825",rank:1,country:"CA",pp:"21027.39",countryRank:1},{name:"oermergeesh",rank:2,country:"US",pp:"20970.75",countryRank:1},{name:"Brazy",rank:3,country:"CA",pp:"20750.65",countryRank:2},{name:"Matty",rank:4,country:"GB",pp:"20627.97",countryRank:1},{name:"Bytesy",rank:5,country:"US",pp:"20461.87",countryRank:2},{name:"Haste",rank:6,country:"NZ",pp:"19888.94",countryRank:1},{name:"chaturbate demon",rank:7,country:"GB",pp:"19770.54",countryRank:2},{name:"Shorties1326",rank:9,country:"US",pp:"18984.28",countryRank:3},{name:"Kira",rank:10,country:"US",pp:"18734.80",countryRank:4},{name:"Davin",rank:11,country:"US",pp:"18713.44",countryRank:5},{name:"Kaelorr",rank:12,country:"US",pp:"18548.63",countryRank:6},{name:"Huskereeno",rank:13,country:"IS",pp:"18484.96",countryRank:1},{name:"Arab Twink",rank:14,country:"US",pp:"18418.10",countryRank:7},{name:"TornadoEF6",rank:15,country:"US",pp:"18377.59",countryRank:8},{name:"Marsh_era",rank:16,country:"JP",pp:"18307.85",countryRank:1},{name:"Smallfox",rank:17,country:"SE",pp:"18245.11",countryRank:1},{name:"Shoogie",rank:18,country:"IL",pp:"18218.22",countryRank:1},{name:"Tranch",rank:19,country:"US",pp:"18060.96",countryRank:9},{name:"snowwisslow",rank:20,country:"US",pp:"18057.20",countryRank:10},{name:"thinking",rank:21,country:"US",pp:"18040.81",countryRank:11},{name:"LeF273",rank:22,country:"US",pp:"17926.74",countryRank:12},{name:"BASKINMYMUDPILE",rank:23,country:"US",pp:"17909.63",countryRank:13},{name:"Sands",rank:24,country:"HU",pp:"17903.37",countryRank:1},{name:"penguiin",rank:25,country:"US",pp:"17861.99",countryRank:14},{name:"Plus",rank:26,country:"CA",pp:"17709.31",countryRank:3},{name:"NailikLP",rank:27,country:"DE",pp:"17702.00",countryRank:1},{name:"udon",rank:28,country:"US",pp:"17665.89",countryRank:15},{name:"hua leu tan tan tan",rank:29,country:"US",pp:"17530.08",countryRank:16},{name:"speecil",rank:30,country:"AU",pp:"17502.73",countryRank:1},{name:"William Virtual Reality",rank:31,country:"AU",pp:"17460.59",countryRank:2},{name:"Tiku",rank:32,country:"ES",pp:"17403.89",countryRank:1},{name:"Luck",rank:33,country:"DK",pp:"17399.80",countryRank:1},{name:"Taichidesu",rank:34,country:"JP",pp:"17392.20",countryRank:2},{name:"Rac",rank:35,country:"DK",pp:"17387.00",countryRank:2},{name:"Ayyserr",rank:36,country:"US",pp:"17348.17",countryRank:17},{name:"Parapass",rank:37,country:"US",pp:"17332.97",countryRank:18},{name:"SaltyButter",rank:38,country:"US",pp:"17304.85",countryRank:19},{name:"VoltageO",rank:39,country:"GB",pp:"17270.64",countryRank:3},{name:"BSFR | risi",rank:40,country:"FR",pp:"17221.51",countryRank:1},{name:"Shani132",rank:41,country:"NZ",pp:"17190.61",countryRank:2},{name:"charlie1epicdude",rank:42,country:"FR",pp:"17188.99",countryRank:2},{name:"Rotech",rank:43,country:"AU",pp:"17175.23",countryRank:3},{name:"fqrb",rank:45,country:"NL",pp:"17103.02",countryRank:1},{name:"Kryptec",rank:46,country:"US",pp:"17102.03",countryRank:20},{name:"Tseska",rank:48,country:"FI",pp:"17043.07",countryRank:1},{name:"_Robertas",rank:49,country:"SE",pp:"17037.11",countryRank:2},{name:"A-tach",rank:50,country:"JP",pp:"17001.93",countryRank:3},{name:"yabje",rank:51,country:"NL",pp:"16850.93",countryRank:2},{name:"laaazi",rank:52,country:"US",pp:"16832.62",countryRank:22},{name:"Mewtex",rank:54,country:"US",pp:"16748.97",countryRank:23},{name:"Shashumga",rank:55,country:"NL",pp:"16717.49",countryRank:3},{name:"Tanhis",rank:56,country:"FI",pp:"16703.79",countryRank:2},{name:"HolyKaes",rank:57,country:"NL",pp:"16635.88",countryRank:4},{name:"Stud3nt_4thlete",rank:58,country:"CA",pp:"16588.94",countryRank:4},{name:"IlluminatiSalad",rank:59,country:"RU",pp:"16585.46",countryRank:2},{name:"Kaizen",rank:60,country:"NZ",pp:"16535.44",countryRank:3},{name:"blinxap",rank:61,country:"US",pp:"16530.15",countryRank:24},{name:"CoolingCloset",rank:62,country:"NL",pp:"16529.57",countryRank:5},{name:"JujuLipz",rank:63,country:"AU",pp:"16515.58",countryRank:4},{name:"Dasher3992",rank:64,country:"US",pp:"16464.23",countryRank:25},{name:"Creeper",rank:65,country:"AU",pp:"16420.62",countryRank:5},{name:"tecmonke",rank:66,country:"US",pp:"16389.03",countryRank:26},{name:"Yurkleee",rank:67,country:"GB",pp:"16362.62",countryRank:4},{name:"Adi",rank:68,country:"BG",pp:"16281.70",countryRank:1},{name:"Hatsune Miku",rank:69,country:"US",pp:"16275.13",countryRank:27},{name:"pinapple",rank:70,country:"GB",pp:"16272.32",countryRank:5},{name:"Staces",rank:71,country:"US",pp:"16259.46",countryRank:28},{name:"BigOlDumplin",rank:72,country:"NL",pp:"16223.87",countryRank:6},{name:"Moepop",rank:73,country:"US",pp:"16219.00",countryRank:29},{name:"Noob_8",rank:74,country:"US",pp:"16198.58",countryRank:30},{name:"raccoonvr",rank:75,country:"CA",pp:"16182.40",countryRank:5},{name:"Praunt",rank:76,country:"BR",pp:"16181.29",countryRank:1},{name:"Xarope93",rank:78,country:"BR",pp:"16158.17",countryRank:2},{name:"VortexWizrd",rank:79,country:"US",pp:"16146.56",countryRank:32},{name:"Latest",rank:80,country:"NO",pp:"16074.86",countryRank:1},{name:"WDG_Death",rank:81,country:"US",pp:"16055.54",countryRank:33},{name:"chicken",rank:82,country:"US",pp:"16043.99",countryRank:34},{name:"floatyoats",rank:83,country:"GB",pp:"16043.03",countryRank:6},{name:"Simbo",rank:84,country:"DK",pp:"16036.61",countryRank:3},{name:"sharkzy",rank:85,country:"CA",pp:"16018.55",countryRank:6},{name:"remondv",rank:86,country:"NL",pp:"15993.00",countryRank:7},{name:"Derpypig42",rank:87,country:"US",pp:"15978.33",countryRank:35},{name:"azu azu",rank:88,country:"US",pp:"15972.58",countryRank:36},{name:"PulseLane",rank:89,country:"US",pp:"15968.02",countryRank:37},{name:"AceBat",rank:90,country:"US",pp:"15966.74",countryRank:38},{name:"ima",rank:91,country:"US",pp:"15942.08",countryRank:39},{name:"edgyguns",rank:92,country:"US",pp:"15930.51",countryRank:40},{name:"twerklearner456",rank:93,country:"US",pp:"15918.88",countryRank:41},{name:"Mr_biologie",rank:94,country:"NL",pp:"15913.24",countryRank:8},{name:"Swimerx",rank:95,country:"US",pp:"15886.18",countryRank:42},{name:"Dr.Bread",rank:96,country:"DE",pp:"15868.28",countryRank:2},{name:"Manski",rank:97,country:"US",pp:"15830.63",countryRank:43},{name:"I drink soda I eat pizza",rank:98,country:"FR",pp:"15829.82",countryRank:3},{name:"noam15A",rank:99,country:"IL",pp:"15783.26",countryRank:2},{name:"MinnieFops",rank:100,country:"AU",pp:"15772.94",countryRank:6}].map(e=>({...e,profilePicture:Qp(e.name),color:Math.random()>.5?"red":"blue"}))}class ai{static instance=null;ticker;scene;targets;rail;hud;score=0;streak=0;isPlaying=!1;projectiles=[];mouseX=0;mouseY=0;targetCameraX=0;targetCameraY=0;constructor(){}static getInstance(){return ai.instance||(ai.instance=new ai),ai.instance}async init(){console.log("🎮 SS-Credits Game initializing..."),this.ticker=new Bp,this.scene=new Yp,this.hud=new Zp,this.rail=new $p,this.targets=new Kp,console.log("📡 Fetching ScoreSaber data...");const e=await Jp(100);console.log(`✅ Loaded ${e.length} players`),this.targets.setPlayers(e),this.setupInput(),this.ticker.subscribe(this.update.bind(this)),console.log("🚀 Game ready! Click to start."),this.hud.showMessage("Left Click = 🔴  Right Click = 🔵",0)}setupInput(){const e=this.scene.renderer.domElement;e.addEventListener("click",t=>{if(!this.isPlaying){this.start();return}this.shoot(t.clientX,t.clientY,"red")}),e.addEventListener("contextmenu",t=>{if(t.preventDefault(),!this.isPlaying){this.start();return}this.shoot(t.clientX,t.clientY,"blue")}),e.addEventListener("mousemove",t=>{this.mouseX=t.clientX,this.mouseY=t.clientY,this.hud.updateCrosshair(t.clientX,t.clientY);const n=window.innerWidth/2,r=window.innerHeight/2;this.targetCameraX=(t.clientX-n)/n*2,this.targetCameraY=(t.clientY-r)/r*-1.5})}start(){this.isPlaying=!0,this.score=0,this.streak=0,this.projectiles=[],this.rail.start(),this.targets.start(),this.hud.hideMessage(),console.log("🎬 Game started!")}shoot(e,t,n){const r=new Ae(e/window.innerWidth*2-1,-(t/window.innerHeight)*2+1),s=this.scene.camera,a=new I(r.x,r.y,.5).unproject(s).sub(s.position).normalize(),o=new wr(.15,8,8),l=n==="red"?16724838:3368703,c=new Ii({color:l,transparent:!0,opacity:.9}),h=new Ot(o,c);h.position.copy(s.position);const f=new wr(.3,8,8),d=new Ii({color:l,transparent:!0,opacity:.3}),g=new Ot(f,d);h.add(g);const _={mesh:h,velocity:a.multiplyScalar(80),color:n,alive:!0};this.projectiles.push(_),this.scene.scene.add(h),this.hud.showShot(n,e,t)}update(e){this.updateCameraParallax(e),this.isPlaying&&(this.rail.update(e),this.targets.update(e),this.updateProjectiles(e),this.rail.isFinished&&this.gameOver())}updateCameraParallax(e){const t=1-Math.pow(.01,e),n=this.scene.camera,r=Math.sin(performance.now()*5e-4)*2,s=Math.cos(performance.now()*3e-4)*1.5,a=r+this.targetCameraX,o=s+this.targetCameraY;n.position.x+=(a-n.position.x)*t*.3,n.position.y+=(o-n.position.y)*t*.3}updateProjectiles(e){for(let t=this.projectiles.length-1;t>=0;t--){const n=this.projectiles[t];if(!n.alive)continue;n.mesh.position.add(n.velocity.clone().multiplyScalar(e));const r=this.targets.checkHit(n.mesh.position,n.color);if(r){this.onHit(r.player,r.correct,n.mesh.position),this.removeProjectile(n);continue}(n.mesh.position.z<-200||n.mesh.position.z>50)&&this.removeProjectile(n)}}onHit(e,t,n){if(t){this.streak++;const r=1+Math.floor(this.streak/5);this.score+=r,this.hud.showHit(e.name,r,this.mouseX,this.mouseY),console.log(`✅ Correct! ${e.name} (+${r}) Streak: ${this.streak}`)}else this.streak=0,this.hud.showMiss("Wrong color!",this.mouseX,this.mouseY),console.log(`❌ Wrong color! ${e.name}`);this.hud.updateScore(this.score,this.streak)}removeProjectile(e){e.alive=!1,this.scene.scene.remove(e.mesh),e.mesh.geometry.dispose(),e.mesh.material.dispose()}gameOver(){this.isPlaying=!1;for(const e of this.projectiles)e.alive&&this.removeProjectile(e);this.projectiles=[],this.hud.showMessage(`Game Over! Score: ${this.score}`,5e3),console.log(`🏁 Game Over! Final Score: ${this.score}`)}}const Tn=ai.getInstance();document.body.style.cursor="none";Tn.init().catch(console.error);
//# sourceMappingURL=index-CtNT7uCL.js.map
